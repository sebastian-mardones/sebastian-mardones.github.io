  ...
  <body>
    ...
    <section>
        <div class="container-section">
            <div class="fotos">
                <img class="img" src="../img/deeperUnder-1l.jpg" alt="">
            </div>
            <div class="texto">
                <h1 class="title">Deeper Underground TopCrop 1l</h1>
                <p>$9.100</p>
                ...
                <div class="from">
                    <form class="tamanio">
                        ...
                        <select value="tamaño" name="producto" maxlength="15" id="producto" required>
                          <option value="3 seeds">250 ml</option>
                          <option value="5 seeds">1 L</option>                          
                        </select>
                        <!-- <button type="button" class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" >
                            seleccionar tamaño
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#">250 ml</a></li>
                            <li><a class="dropdown-item" href="#">1 litro</a></li>
                        </ul> -->
                        <hr>
                        <p>cantidad</p>
        ...
        <div class="fb-comments" data-href="https://jsoza.ilab.cl/DPOW2022-1/sebastian.mardones/productos/deeperUnder.php" data-width="100%" data-numposts="1" data-colorscheme="dark" data-mobile="true"></div>
