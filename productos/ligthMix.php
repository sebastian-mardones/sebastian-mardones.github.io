  ...
  <body>
    ...
    <section>
        <div class="container-section">
            <div class="fotos">
                <img class="img" src="../img/ligthMix.jpg" alt="">
            </div>
            <div class="texto">
                <h1 class="title">Ligth Mix biobizz 50l</h1>
                <p>$12.000</p>
        ...
        <div class="fb-comments" data-href="https://jsoza.ilab.cl/DPOW2022-1/sebastian.mardones/productos/ligthMix.php" data-width="100%" data-numposts="1" data-colorscheme="dark" data-mobile="true"></div>
