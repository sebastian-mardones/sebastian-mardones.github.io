  ...
  <body>
    ...
    <section>
        <div class="container-section">
            <div class="fotos">
                <img class="img" src="../img/allMix.jpg" alt="">
            </div>
            <div class="texto">
                <h1 class="title" id="title">All Mix biobizz 50l</h1>
                <p>$13.000</p>
                ...
                <div class="from">
                    <form class="tamanio" action="../src/carrito.php" method="post">
                        <p>tamaño</p>
                        <select value="tamaño" name="producto" maxlength="15" id="producto" required>
                          <option value="">10L</option>
                          <option value="">50L</option>                          
                        </select>
                        <!-- <button type="button" id ="tamanio" class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" method="post">
                            seleccionar tamaño
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#">20 litros</a></li>
                            <li><a class="dropdown-item" href="#">50 litros</a></li>
                        </ul> -->
                        <hr>
                        <p>cantidad</p>
                        <input class="cantidad" type="number" placeholder="ingresar cantidad" id="cantidad" name="cantidad">  
