        ...
        <div class="container-fluid" id="fondo">
            <div class="row-head">
              <div class="container">
                  <div class="row">
                      <div class="col-lg-12">
                          <form action="validarUsuario.php" method="post"><br>
                            <h3>Inicio de sesion</h3> <br>
                          <h5>Correo </h5>
                          <input type="email" name="correo" id="correo" required placeHolder="Ingrese su correo"> <br> 
                          <h5>Password </h5>
                          <input type="password" name="password" id="password" required placeHolder="Ingrese su contraseña"> <br><br>
                          <input type="submit" value= "iniciar sesion" id="iniciarSesionbtn"> <br> <br>
                          <a href="registrarUsuario.php">¿No tienes cuenta? ¡registra una cuenta nueva!</a>
